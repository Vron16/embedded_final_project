...
proc create_root_design { parentCell } {
  ...
  set Addr [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 Addr ]
  set DDR [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:ddrx_rtl:1.0 DDR ]
  set FIXED_IO [ create_bd_intf_port -mode Master -vlnv xilinx.com:display_processing_system7:fixedio_rtl:1.0 FIXED_IO ]
  set LDATA [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 LDATA ]
  set LDATA_RDY [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 LDATA_RDY ]
  set SWITCHES [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 SWITCHES ]
  set data [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 data ]
  set gpio_rtl [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 gpio_rtl ]
  set ready [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 ready ]
  set reset [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 reset ]
  set timer_gpio [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 timer_gpio ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports LDATA_RDY] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports LDATA] [get_bd_intf_pins axi_gpio_0/GPIO2]
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports SWITCHES] [get_bd_intf_pins axi_gpio_1/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_2_GPIO [get_bd_intf_ports Addr] [get_bd_intf_pins axi_gpio_2/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_2_GPIO2 [get_bd_intf_ports data] [get_bd_intf_pins axi_gpio_2/GPIO2]
  connect_bd_intf_net -intf_net axi_gpio_3_GPIO [get_bd_intf_ports ready] [get_bd_intf_pins axi_gpio_3/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_3_GPIO2 [get_bd_intf_ports reset] [get_bd_intf_pins axi_gpio_3/GPIO2]
  connect_bd_intf_net -intf_net axi_gpio_4_GPIO [get_bd_intf_ports timer_gpio] [get_bd_intf_pins axi_gpio_4/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_4_GPIO2 [get_bd_intf_ports gpio_rtl] [get_bd_intf_pins axi_gpio_4/GPIO2]
